@extends('admin.layout.app', ['title' => 'Users - Admin'])

@section('main')
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Users - Admin</h1>
    ...
    @include('admin.pages.users.admin.component.add-modal')
    @include('admin.pages.users.admin.component.edit-modal')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#editItem', function() {
                ...
                $.get("{{ route('user-admin') }}" + '/' + civitas_id + '/edit', function(data) {
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "{{ route('user-admin') }}" + '/' + company_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
